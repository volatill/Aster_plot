...
set label "(E) Random Walk" at screen 0.225,0.05 font "Helvetica,12"
set label "(F) Personalized PageRank" at screen 0.68,0.05 font "Helvetica,12"

set origin 0.0,0.2
set size 0.53,0.8
plot 'rw.dat' using 2:xticlabels(1) title columnheader(2) lc rgb Neo4j, \
...
plot 'rw.dat' using 2:xticlabels(1) title columnheader(2) fillstyle solid lc rgb Neo4j,\
...
set ytics 1,10,10000000000 nomirror font "Helvetica,10" offset 0.6, 0
set yrange [1500000:7200000000]
set ytics ('1' 1, '10' 10, '10^2' 100, '10^3' 1000, '10^4' 10000,'10^5' 100000, '10^6' 1000000, '10^7' 10000000, '10^8' 100000000, '10^9' 1000000000)

# set xlabel "workload composition(range read,update,point read)(%)" font "Helvetica,17" off 0,-1.5
set style fill solid border -1
set origin 0.4765,0.2
set size 0.52,0.8
plot 'ppr.dat' using 2:xticlabels(1) title columnheader(2) lc rgb Neo4j, \
'' using 3:xticlabels(1) title columnheader(3) lc rgb ArangoDB,\
'' using 5:xticlabels(1) title columnheader(4) lc rgb OrientDB,\
'' using 4:xticlabels(1) title columnheader(5) lc rgb PostgreSQL,\
'' using 6:xticlabels(1) title columnheader(6) lc rgb JanusGraph,\
...
set size 0.52,0.8
set style fill pattern border -1
plot 'ppr.dat' using 2:xticlabels(1) title columnheader(2) fillstyle solid lc rgb Neo4j,\
'' using 3:xticlabels(1) title columnheader(3) fillstyle pattern 1 transparent lc rgb 'black',\
'' using 5:xticlabels(1) title columnheader(4) fillstyle pattern 2 transparent lc rgb 'white',\
'' using 4:xticlabels(1) title columnheader(5) fillstyle pattern 4 transparent lc rgb 'black',\
'' using 6:xticlabels(1) title columnheader(6) fillstyle pattern 15 transparent lc rgb 'black',\
